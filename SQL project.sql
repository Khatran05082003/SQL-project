...
create table CHITIETDDH (
	...
	DonGia float,
	SoLuong int,
	constraint CHITIET_PK primary key (MaCT,MaDDH)
);
...
alter table CHITIETDDH add constraint CHITIETDDH_DONDATHANG_FK foreign key (MaDDH) references DONDATHANG (MaDDH);
...
insert into MATHANG values (1,'Chai', 1,18.0, 0);
insert into MATHANG values (2,'Chang', 1,19.0, 0);
insert into MATHANG values (3,'Aniseed Syrup', 1,10.0, 0);
insert into MATHANG values (4,'Chef Anton s Cajun Seasoning', 2,22.0, 0);
insert into MATHANG values (5,'Chef Anton s Gumbo Mix', 2,21.35, 1);
insert into MATHANG values (6,'Grandma s Boysenberry Spread', 3,25.0, 0);
insert into MATHANG values (7,'Uncle Bob s Organic Dried Pears', 3,30.0, 0);
insert into MATHANG values (8,'Northwoods Cranberry Sauce', 3,40.0, 0);
insert into MATHANG values (9,'Mishi Kobe Niku', 4,97.0, 1);
insert into MATHANG values (10,'Ikura', 4,31.0, 0);
insert into MATHANG values (11,'Queso Cabrales', 5,21.0, 0);
insert into MATHANG values (12,'Queso Manchego La Pastora', 5,38.0, 0);
insert into MATHANG values (13,'Konbu', 6,6.0, 0);
...
insert into MATHANG values (17,'Alice Mutton', 7,39.0, 1);
insert into MATHANG values (18,'Carnarvon Tigers', 7,62.5, 0);
insert into MATHANG values (19,'Teatime Chocolate Biscuits', 8,9.2, 0);
insert into MATHANG values (20,'Sir Rodney s Marmalade', 8,81.0, 0);
insert into MATHANG values (21,'Sir Rodney s Scones', 8,10.0, 0);
insert into MATHANG values (22,'Gustaf s Knackebröd', 9,21.0, 0);
insert into MATHANG values (23,'Tunnbrod', 9,9.0, 0);
insert into MATHANG values (24,'Guarana Fantastica', 10,4.5, 1);
insert into MATHANG values (25,'NuNuCa Nub-Nougat-Creme', 11,14.0, 0);
...
insert into MATHANG values (32,'Mascarpone Fabioli', 14,32.0, 0);
insert into MATHANG values (33,'Geitost', 15,2.5, 0);
insert into MATHANG values (34,'Sasquatch Ale', 16,14.0, 0);
insert into MATHANG values (35,'Steeleye Stout', 16,18.0, 0);
insert into MATHANG values (36,'Inlagd Sill', 17,19.0, 0);
insert into MATHANG values (37,'Gravad lax', 17,26.0, 0);
insert into MATHANG values (38,'Cote de Blaye', 18,263.5, 0);
insert into MATHANG values (39,'Chartreuse verte', 18,18.0, 0);
...
insert into MATHANG values (42,'Singaporean Hokkien Fried Mee', 20,14.0, 1);
insert into MATHANG values (43,'Ipoh Coffee', 20,46.0, 0);
insert into MATHANG values (44,'Gula Malacca', 20,19.45, 0);
insert into MATHANG values (45,'Rogede sild', 21,9.5, 0);
insert into MATHANG values (46,'Spegesild', 21,12.0, 0);
insert into MATHANG values (47,'Zaanse koeken', 22,9.5, 0);
insert into MATHANG values (48,'Chocolade', 22,12.75, 0);
insert into MATHANG values (49,'Maxilaku', 23,20.0, 0);
insert into MATHANG values (50,'Valkoinen suklaa', 23,16.25, 0);
insert into MATHANG values (51,'Manjimup Dried Apples', 24,53.0, 0);
insert into MATHANG values (52,'Filo Mix', 24,7.0, 0);
insert into MATHANG values (53,'Perth Pasties', 24,32.8, 1);
insert into MATHANG values (54,'Tourtiere', 25,7.45, 0);
insert into MATHANG values (55,'Pâté chinois', 25,24.0, 0);
insert into MATHANG values (56,'Gnocchi di nonna Alice', 26,38.0, 0);
insert into MATHANG values (57,'Ravioli Angelo', 26,19.5, 0);
insert into MATHANG values (58,'Escargots de Bourgogne', 27,13.25, 0);
insert into MATHANG values (59,'Raclette Courdavault', 28,55.0, 0);
insert into MATHANG values (60,'Camembert Pierrot', 28,34.0, 0);
...
insert into MATHANG values (66,'Louisiana Hot Spiced Okra', 2,17.0, 0);
insert into MATHANG values (67,'Laughing Lumberjack Lager', 16,14.0, 0);
insert into MATHANG values (68,'Scottish Longbreads', 8,12.5, 0);
insert into MATHANG values (69,'Gudbrandsdalsost', 15,36.0, 0);
insert into MATHANG values (70,'Outback Lager', 7,15.0, 0);
insert into MATHANG values (71,'Flotemysost', 15,21.5, 0);
insert into MATHANG values (72,'Mozzarella di Giovanni', 14,34.8, 0);
insert into MATHANG values (73,'Rod Kaviar', 17,15.0, 0);
insert into MATHANG values (74,'Longlife Tofu', 4,10.0, 0);
insert into MATHANG values (75,'Rhonbrau Klosterbier', 12,7.75, 0);
insert into MATHANG values (76,'Lakkalikoori', 23,18.0, 0);
insert into MATHANG values (77,'Original Frankfurter grune Sobe', 12,13.0, 0);
insert into MATHANG values (78,'Stroopwafels', 22,9.75, 0);


insert into DONDATHANG values (1,'2012-7-4', 15,440.0);
insert into DONDATHANG values (2,'2012-7-5', 9,1863.4);
insert into DONDATHANG values (3,'2012-7-8', 34,1813.0);
insert into DONDATHANG values (4,'2012-7-8', 14,670.8);
insert into DONDATHANG values (5,'2012-7-9', 26,3730.0);
insert into DONDATHANG values (6,'2012-7-10', 34,1444.8);
insert into DONDATHANG values (7,'2012-7-11', 14,625.2);
insert into DONDATHANG values (8,'2012-7-12', 38,2490.5);
insert into DONDATHANG values (9,'2012-7-15', 28,517.8);
insert into DONDATHANG values (10,'2012-7-16', 35,1119.9);


insert into CHITIETDDH values (1,1,11,14.0,12);
...
insert into CHITIETDDH values (6,3,41,7.7,10);
...
insert into CHITIETDDH values (24,8,59,44.0,30);
...
--2 Cho biết danh sách các khách hàng. Sắp xếp theo thứ tự tăng của họ tên khách hàng, thứ tự giảm của tên quốc gia.
select * from KHACHHANG
order by HoTen ASC, QuocGia DESC


--3 Cho biết mã số, họ tên, số điện thoại của các khách hàng có tên bắt đầu bằng chữ L
select MaKH,HoTen,SoDT 
from KHACHHANG
where HoTen like 'L%'


--4 Với các nhà cung cấp ở Germany, cho biết mã số, tên nhà cung cấp và mã số, tên các mặt hàng của họ.
select NCC.MaNCC,NCC.TenNCC,MH.MaMH,MH.TenMH
from NHACUNGCAP as NCC
join MATHANG as MH
on NCC.MaNCC=MH.MaNCC
where NCC.QuocGia='Germany'


--5 Cho biết số lượng nhà cung cấp có nguồn gốc ở France. 
select count(MaNCC)
from NHACUNGCAP
where QuocGia='France'


--6 Cho biết mã số, địa chỉ, số điện thoại và tổng trị giá các đơn hàng của khách hàng có tên Yang Wang. select KH.MaKH,KH.DiaChi,KH.SoDT,sum(DDH.TriGia) as TongTriGia
...
--7 Cho biết mã số, tên, đơn giá và đơn giá đặt hàng trung bình, tổng số lượng của các mặt hàng được đặt hàng trong tháng 07/2012. 
select MH.MaMH,MH.TenMH,MH.DonGia,avg(CT.DonGia) as DonGiaTB,sum(CT.SoLuong) as TongSoLuong
from MATHANG as MH
join CHITIETDDH as CT
on MH.MaMH=CT.MaMH
join DONDATHANG as DDH
on CT.MaDDH=DDH.MaDDH
where DDH.NgayDatHang>='2012-07-01' and DDH.NgayDatHang<='2012-07-31'
...
--8 Cho biết các khách hàng mà tổng trị giá tất cả các đơn đặt hàng của họ lớn hơn 3,000.
select KH.MaKH,KH.HoTen,sum(TriGia) as TongTriGia
from KHACHHANG as KH
join DONDATHANG as DDH
on DDH.MaKH=KH.MaKH
...
--9 Với mỗi nhà cung cấp, cho biết mã số, tên, email và tổng số mặt hàng có đơn giá lớn hơn 30 mà họ cung cấp.
select NCC.MaNCC, TenNCC, Email, count(MH.MaNCC) SoDDH_Lon_Hon_30
from NHACUNGCAP as NCC
join MATHANG as MH
on NCC.MaNCC=MH.MaNCC
where MH.DonGia>30
group by NCC.MaNCC,TenNCC,Email


--10 Cho biết mã số, tên các mặt hàng với số lượng được đặt hàng nhiều nhất.
select Top 1 MH.MaMH,TenMH,sum(CTDDH.SoLuong) as SoLuongMH
from MATHANG as MH
join CHITIETDDH as CTDDH
on MH.MaMH=CTDDH.MaMH
group by MH.MaMH,MH.TenMH
order by SoLuongMH desc


--11 Cho biết mã số, họ tên, email của các khách hàng không đặt mặt hàng của các nhà cung cấp từ Japan.
...
on MH.MaNCC=NCC.MaNCC
where NCC.QuocGia!='Japan' 


--12 Cho biết mã số, tên, đơn giá của các mặt hàng xuất hiện trong tất cả các đơn đặt hàng của khách hàng có mã số 34.
...
--13 Cho biết các khách hàng ở Brazil có đơn đặt hàng có trị giá lớn nhất.
select KH.MaKH,HoTen,TriGia
from KHACHHANG as KH
join DONDATHANG as DDH
on DDH.MaKH=KH.MaKH
